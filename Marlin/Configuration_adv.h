...
#define AUTOTEMP
  ...
  #define AUTOTEMP_MIN   195
  #define AUTOTEMP_MAX   205
  #define AUTOTEMP_FACTOR   1
...
#if EITHER(SDSUPPORT, SET_PROGRESS_MANUALLY) && ANY(HAS_MARLINUI_U8GLIB, HAS_MARLINUI_HD44780, IS_TFTGLCD_PANEL)
